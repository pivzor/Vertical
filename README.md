Вот улучшенный, «дипломный уровень» `README.md`, собранный по твоему Word + презентации (я привёл текст к нормальному GitHub-стилю, убрал дубли и усилил структуру, чтобы выглядело как реальный коммерческий/дипломный проект).
...
* вычисление углов
* работа алгоритма оценки
* устойчивость к ошибкам
* работа с камерой и БД

---

## 📈 Результаты проекта

* реализована система анализа осанки в реальном времени
* создана база данных пользователей и статистики
* разработан UI интерфейс на PyQt5
* обеспечена работа через веб-камеру без дополнительных устройств
* реализована автоматическая установка PostgreSQL
